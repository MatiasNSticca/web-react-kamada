  ...
  return (
    <nav className={style.nav}>
      ...
      <ul className={`${style.nav__list} ${isOpen ? style["nav__list--open"] : ""}`}>
        ...
        {/* Panel de Admin - visible para admins y master */}
        {isAdmin && (
          <li className={style.nav__item}>
            <NavLink to="/admin/productos" className={getLinkClass} onClick={toggleMenu}>
              Admin Productos
            </NavLink>
          </li>
        )}

        {/* Solo master_admin puede ver gestión de usuarios */}
        {isMaster && (
          <li className={style.nav__item}>
            <NavLink to="/admin/usuarios" className={getLinkClass} onClick={toggleMenu}>
              Admin Usuarios
            </NavLink>
          </li>
        )}
